...
Usage:
  ...
  python3 save_configs.py --prefix clab-segment-routing-lab2 --nodes r1 r2 r3 r4 r5 r6 r7 --outdir config
"""
...
def main():
    ...
    ap.add_argument("--prefix", default="clab-segment-routing-lab2",
                    help="Container name prefix (default: clab-segment-routing-lab2)")
    ap.add_argument("--nodes", nargs="*", default=None,
                    help="Node short names (e.g. r1 r2 r3 r4 r5 r6 r7). Auto-discovered if omitted.")
